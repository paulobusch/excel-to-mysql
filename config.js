module.exports = {
    ...
    Scripts: {
        ...
        insertCustomer: "insert into customers(`id`, `name`, `id_responsible`, `cpf`, `cnpj`, `birth`, `situation_doc`, `child_can_view`, `date_update_cpf`, `date_update_cnpj`, `id_update_cpf_user`, `id_update_cnpj_user`, `id_address`, `id_priority`, `id_list`, `id_creation_user`, `id_update_user`, `customer_created`, `customer_updated`)",

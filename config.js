module.exports = {
    ...
    Columns: {
        ...
        customer: [`id`, `kf`, `birth`, `situation_doc`, `child_can_view`, `date_update_cpf`, `date_update_cnpj`, `id_update_cpf_user`, `id_update_cnpj_user`, `name`, 'email', 'id_responsible', `cpf`, `cnpj`, 'tel_fix', 'phone', 'contact', 'id_address', 'id_priority', `id_creation_user`, `id_update_user`, `customer_created`, `customer_updated`, `observation`],

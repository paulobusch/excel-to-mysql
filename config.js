module.exports = {
    ...
    Columns: {
        ...
        customer: [`id`, `name`, 'email', 'id_responsible', `cpf`, `cnpj`, 'tel_fix', 'phone', 'contact', 'id_address', 'id_priority', `id_creation_user`, `id_update_user`, `customer_created`, `customer_updated`, `observation`],
